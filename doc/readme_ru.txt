...
Требования:
Anomaly 1.5.3
Modded exes: themrdemonized 2025.9.10 или новее, либо AOEngine v0.55 или новее. Полный набор функций требует последней сборки demonized; функция, которой нужна более новая, остаётся неактивной на старых exe.
xlibs (https://www.moddb.com/mods/stalker-anomaly/addons/xlibs-1001)
MCM
...
Совместимость:
Сосуществует с модами, которыми управляет. Подключается к ph_sound, guitar_anim и harmonica_anim; элемент управления неактивен, когда его мод отсутствует.
Протестирован с Anomaly 1.5.3, GAMMA и Forgotten Zone.
...
Паттерны кода и использование движка валидированы по работам авторитетных Anomaly-моддеров (Demonized, Vintar0, RavenAscendant, xcvb).
...
Создайте отчёт на https://github.com/damiansirbu-stalker/AlifeDiegetic/issues/new/choose или спросите на Discord-серверах EFP, Anomaly и Zona. Сначала прочитайте этот readme и настройки MCM.
